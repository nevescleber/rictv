        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-6 mb-4">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="/ric-wp/codigo-de-cultura" class="text-white text-decoration-none mb-2 d-block hover-underline">Código de Cultura</a></li>
                    <li><a href="/ric-wp/principios-editoriais" class="text-white text-decoration-none mb-2 d-block hover-underline">Principios Editoriais</a></li>
            ...
            <div class="col-lg-2 col-6 mb-4">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="programas.php" class="text-white text-decoration-none mb-2 d-block hover-underline">Programas</a></li>-->
                </ul>
            </div>
