                ...
                <div class="row projetos-grid">
                        ...
                        <a href="projetos-especiais-inner.php" class="projeto-link">
                            <div class="projeto-box">
                                <div class="projeto-imagem">
                                    <img src="assets/img/expoinga.png" alt="Expoingá 2025">
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <a href="projetos-especiais-inner.php" class="projeto-link">
                            <div class="projeto-box">
                                <div class="projeto-imagem">
                                    <img src="assets/img/vidas.png" alt="Projeto Vidas">
                                </div>
                                <div class="projeto-content">
                                    <div class="projeto-tags">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <a href="projetos-especiais-inner.php" class="projeto-link">
                            <div class="projeto-box">
                                <div class="projeto-imagem">
                                    <img src="assets/img/circulo-do-bem.png" alt="Círculo do Bem 2025">
                                </div>
                                <div class="projeto-content">
                                    <div class="projeto-tags">
                                        <span class="tag topview">TOPVIEW</span>
