            ...
            <div class="swiper main-slider">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <img src="assets/img/bg-veiculos.jpg" alt="RIC TV">
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-12">
                                        <h1>Veículos</h1>
                                        <p>
                                            Veículos de alta reputação em jornalistmo e entretenimento com conteúdos de credibilidade e 
                                            <br>ativos em diversas plataformas.
                                        </p>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="container">
                ...
                <div class="row midia-kit-grid">
                    <div class="col-lg-3 col-md-6 col-12">
                        <a href="/ric/veiculos-inner.php" class="midia-kit-link">
                            <div class="midia-kit-box">
                                <img src="assets/img/img-veiculos.jpg" alt="Mídia Kit 1">
                            </div>
                        </a>
                    </div>
                    <div class="col-lg-3 col-md-6 col-12">
