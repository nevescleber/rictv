<footer class="footer py-5">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-2 mb-4">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/logo-vertical.png" alt="Grupo RIC" class="img-fluid mb-4" style="max-width: 150px;">
            ...
            <!-- Coluna 6 - Políticas -->
            <div class="col-lg-2 mb-4">
                <h5 class="text-white mb-3">Políticas</h5>
                <ul class="list-unstyled">
    ...
    <div class="container mt-4 copyright">
